      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          ...
          <div className={`${styles.grid} grid mb-12`}>
            <a class="card w-96 bg-base-100 shadow-xl" href='https://www.curseforge.com/minecraft/mc-mods/random-loot-mod'>
              ...
              <div class="card-body">
                ...
                <div class="card-actions justify-end">
                  <div class="badge badge-outline">Minecraft</div>
                  <div class="badge badge-outline">Java</div>
                </div>
              </div>
            </a>

            <a class="card w-96 bg-base-100 shadow-xl" href='https://jackaldao.com/'>
              ...
              <div class="card-body">
                ...
                <div class="card-actions justify-end">
                  <div class="badge badge-outline">Blockchain</div>
                  <div class="badge badge-outline">Storage</div>
                  <div class="badge badge-outline">Golang</div>
                </div>
              </div>
            </a>

            <a class="card w-96 bg-base-100 shadow-xl" href='https://marstonc.itch.io/pathway-protectors'>
              ...
              <div class="card-body">
                ...
                <div class="card-actions justify-end">
                  <div class="badge badge-outline">Game Design</div>
                  <div class="badge badge-outline">Python</div>
                </div>
              </div>
            </a>

            <a class="card w-96 bg-base-100 shadow-xl" href='https://github.com/TheMarstonConnell/cookies'>
            ...
            <a class="card w-96 bg-base-100 shadow-xl" href='https://github.com/TheMarstonConnell/Hailstorm'>
